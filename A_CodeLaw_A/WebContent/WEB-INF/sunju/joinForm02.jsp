<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%-- <c:set var="agree" value="${ param.agree }" /> --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>선주회원 기본 정보 입력</title>
	...
	$(function(){
		...
		$("#emailCheck").on("click", function(){
			...
			if(email1.length <= 0 || email2.length <= 0){
				...
				url="emailCheck.mvc?email1="+email1+"&email2="+email2;
...
<body style="background-color: aliceblue;">
    ...
    margin-bottom: 4%;"
 >
	<h2>선주회원 기본 정보 입력</h2><br>
	<form action="joinInfo1.mvc" method="post" name="joinForm" id="joinForm">
	<p>아이디</p>
	...
	<p>사업자번호</p>
	<p><input type="text" name="sunju_code" id="sunju_code" placeholder="사업자 번호를 입력해주세요"></p>
	<p>비밀번호</p>
	...
	<span><input type="button" value="인증요청" id="emailCheck" name="emailCheck"></span>
	<input type="hidden" name="authNumCheck" id="authNumCheck" value="false">
	</p>
	<br/><br/><br/>
	<p>
