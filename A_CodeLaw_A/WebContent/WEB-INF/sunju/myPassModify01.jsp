...
<form method="post" id="passModifyForm" name="passModifyForm" action="memberPassModify1.mvc">
<h2>비밀번호 변경</h2>
<br/><br/>
<p>현재 비밀번호</p>
...
<br/><br/>
<p>
<input type="submit" value="변경하기" id="passModify" class="btn btn-block btn-lg btn-primary" style="width: 16%;
