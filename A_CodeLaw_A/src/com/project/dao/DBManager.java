...
public class DBManager {
	...
	static {		
		try {
			 ...
			 * 또한 MySQL 접속 드라이버도 필요하므로 http://www.mysql.com에서
			 ...
			 * 즉 java:comp/env는 JNDI에서 룩업할 때 사용하는 빈(객체)의 가상 디렉터리
			 * 공간으로 기본 가상 디렉터리를 java:comp/env로 정해 놓은 것이다.
			 **/ 
	...
	public static Connection getConnection() {
		try {
			...
			// 4. DataSource 객체를 이용해 DPCP로 부터 커넥션을 대여하여 리턴 한다.
